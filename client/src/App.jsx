    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        {!isAuthenticated ? (
          <div className="hero-landing">
            <div className="hero-badge">Civic Grievance Platform</div>
            ...
            <div className="hero-features-grid">
              ...
              <div className="feature-card">
                ...
                <p>
                  Semantic vector search over civic categories automatically matches grievance issues with the right municipal department.
                </p>
              </div>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <span className="footer-tag">Built with React, Node.js Express, MongoDB & Gemini RAG</span>
        </div>
      </footer>
